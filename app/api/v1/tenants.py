...
async def create_tenant(
    tenant: TenantSchemaCreate, session: AsyncSession = Depends(get_async_session)
):
...
@tenant_router.patch("/tenants/{tenant_id}", response_model=TenantSchema)
async def update_tenant(
    tenant_id: str,
    tenant: TenantSchemaUpdate,
...
@tenant_router.get("/tenants/", response_model=TenantSchema)
